...
const { getAllVendors, deleteAnyVendor, getAnyVendorProducts} = require("../controllers/vendorController");
...
router.get( "/vendors/products/:id", protect, authorizeRole("admin"), getAnyVendorProducts);
